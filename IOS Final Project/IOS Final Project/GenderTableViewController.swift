...
class GenderTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        if(currentUser.gender == "1"){
            female.frame = CGRect(x: 0, y: 0, width: 0, height: 0)
            male.frame = CGRect(x: 330, y: 10, width: 30, height: 30)
        }
        else{
            male.frame = CGRect(x: 0, y: 0, width: 0, height: 0)
            female.frame = CGRect(x: 330, y: 10, width: 30, height: 30)
